...
type ScopedRoleDefaults struct {
	...
	SessionRecordingMode *SessionRecording `protobuf:"bytes,2,opt,name=session_recording_mode,json=sessionRecordingMode,proto3" json:"session_recording_mode,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *ScopedRoleDefaults) GetSessionRecordingMode() *SessionRecording {
	if x != nil {
...
type ScopedRoleSSH struct {
	...
	SessionRecordingMode *SessionRecording `protobuf:"bytes,13,opt,name=session_recording_mode,json=sessionRecordingMode,proto3" json:"session_recording_mode,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *ScopedRoleSSH) GetSessionRecordingMode() *SessionRecording {
	if x != nil {
		return x.SessionRecordingMode
	}
	return nil
...
type SessionRecording struct {
	...
	Strict        *bool `protobuf:"varint,1,opt,name=strict,proto3,oneof" json:"strict,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SessionRecording) GetStrict() bool {
...
const file_teleport_scopes_access_v1_role_proto_rawDesc = "" +
	...
	"\x04kube\x18\b \x01(\v2).teleport.scopes.access.v1.ScopedRoleKubeR\x04kubeJ\x04\b\x02\x10\x03J\x04\b\x03\x10\x04R\x05allowR\aoptions\"\xa7\x01\n" +
	"\x12ScopedRoleDefaults\x12.\n" +
	"\x13client_idle_timeout\x18\x01 \x01(\tR\x11clientIdleTimeout\x12a\n" +
	"\x16session_recording_mode\x18\x02 \x01(\v2+.teleport.scopes.access.v1.SessionRecordingR\x14sessionRecordingMode\"\x94\x06\n" +
	...
	"\x12enhanced_recording\x18\f \x01(\v2,.teleport.scopes.access.v1.EnhancedRecordingR\x11enhancedRecording\x12a\n" +
	"\x16session_recording_mode\x18\r \x01(\v2+.teleport.scopes.access.v1.SessionRecordingR\x14sessionRecordingModeB\x18\n" +
	...
	"\b_networkB\a\n" +
	"\x05_disk\":\n" +
	"\x10SessionRecording\x12\x1b\n" +
	"\x06strict\x18\x01 \x01(\bH\x00R\x06strict\x88\x01\x01B\t\n" +
	"\a_strictBWZUgithub.com/gravitational/teleport/api/gen/proto/go/teleport/scopes/access/v1;accessv1b\x06proto3"
...
var file_teleport_scopes_access_v1_role_proto_depIdxs = []int32{
	...
	11, // 6: teleport.scopes.access.v1.ScopedRoleDefaults.session_recording_mode:type_name -> teleport.scopes.access.v1.SessionRecording
	...
	11, // 11: teleport.scopes.access.v1.ScopedRoleSSH.session_recording_mode:type_name -> teleport.scopes.access.v1.SessionRecording
